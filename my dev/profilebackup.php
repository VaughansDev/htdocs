                ...
                <div class="row">
                  <div class="col-lg-7 mb-9 mb-lg-0">
                    ...
                    <div id="about" class="mb-8">
                      ...
                      <div class="row">
                        ...
                        <div class="col-2 col-lg-1 text-right"><a href="#" class="lead-1 text-success"><i class="fas fa-pen"></i></a></div>
                      </div>
                    </div>
                    ...
                    <div id="friends" class="mb-8">
                      <div class="row">
                        <div class="col-10 col-lg-11">
                          ...
                          <hr class="w-10 border-top-2 mt-5 mb-5 ml-0 mr-auto border-success">
                          <span class="d-block mb-4">Offline<span class="text-success lead-1 ml-1">(8)</span></span>
                        </div>
                        <div class="col-2 col-lg-1 text-right">
                          <a href="#" class="lead-1 text-success"><i class="fas fa-search"></i></a>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-12">
                                ...
                                <figure class="owl_item_review">
                                  <div>
                                    <div class="position-relative overflow-hidden">
                                      <img class="mb-2" src="assets/img/avatar/5.jpg" alt="Avatar">
                                      <div class="review_h text-light">
                                        <a href="#" class="d-block">
                                          Trina Squires
                                        </a>
                                        <span class="d-flex align-items-center small-3 text-success"><i class="fas fa-circle small-7 mr-1"></i>Online</span>
                                      </div>
                                    </div>
                                  </div>
                                </figure>
                                  ...
                                  <div>
                                    <div class="position-relative overflow-hidden">
                                      ...
                                      <div class="review_h text-light">
                                        ...
                                        <span class="d-flex align-items-center small-3 text-success"><i class="fas fa-circle small-7 mr-1"></i><span class="fw-500">Online</span></span>
                                      </div>
                                    </div>
                                  </div>
                                </figure>
                            ...
                            <div class="item">
                              <div class="item-cont">
                                <figure class="owl_item_review">
                                  <div>
                                    <div class="position-relative overflow-hidden">
                                      <img class="mb-2" src="assets/img/avatar/4.jpg" alt="Avatar">
                                      <div class="review_h text-light">
                                        <a href="#" class="d-block">
                                          George Collins
                                        </a>
                      ...
                      <div class="row">
                        <div class="col-12">
                          <div class="owl-carousel carousel_sm" data-carousel-items="1, 2, 3, 3" data-carousel-margin="10" data-carousel-nav="false" data-carousel-dots="true">
                            <div class="item">
                              <a href="#">
                                <div class="d-flex h-100 bs-c br-n bp-c ar-8_5 position-relative" style="background-image: url(assets/img/content/img_04.jpg);">
                                  <div class="position-absolute w-100 l-0 b-0 bg-dark_A-80 text-light">
                                    <div class="px-4 py-3 lh-1">
                                      <h6 class="text-lt mb-1 small-1 text-light text-uppercase">Convallis</h6>
                                      <div class="price d-flex flex-wrap align-items-center">
                                        <span class="text-success small-2"><i class="fas fa-eye mr-1"></i>241</span>
                                      </div>
                                    </div>
                                  </div>
                                </div>
                            ...
                            <div class="item">
                              <a href="#">
                                <div class="d-flex h-100 bs-c br-n bp-c ar-8_5 position-relative" style="background-image: url(assets/img/content/img_05.jpg);">
                                  <div class="position-absolute w-100 l-0 b-0 bg-dark_A-80 text-light">
                                    <div class="px-4 py-3 lh-1">
                                      <h6 class="text-lt mb-1 small-1 text-light text-uppercase">Aenean 3</h6>
                                      <div class="price d-flex flex-wrap align-items-center">
                                        <span class="text-success small-2"><i class="fas fa-eye mr-1"></i>241</span>
                                      </div>
                                    </div>
                            ...
                            <div class="item">
                              <a href="#">
                                <div class="d-flex h-100 bs-c br-n bp-c ar-8_5 position-relative" style="background-image: url(assets/img/content/img_06.jpg);">
                                  <div class="position-absolute w-100 l-0 b-0 bg-dark_A-80 text-light">
                                    <div class="px-4 py-3 lh-1">
                                      <h6 class="text-lt mb-1 small-1 text-light text-uppercase">Morbi vitae</h6>
                                      <div class="price d-flex flex-wrap align-items-center">
                                        <span class="text-success small-2"><i class="fas fa-eye mr-1"></i>241</span>
                                      </div>
                                    </div>
                                ...
                                <div class="col-9 col-sm-10">
                                  <div class="comment-main border border-secondary">
                                    <div class="d-md-flex comment-header border-bottom border-secondary px-4 py-3">
                                      ...
                                      <div>
                                        <a href="#" class="comment-metadata text-success small">Aug 12, 2021 at 09:12 AM</a>
                                      </div>
                                    </div>
                                    <div class="p-4">
                                ...
                                <div class="col-9 col-sm-10">
                                  <div class="comment-main border border-secondary">
                                    <div class="d-md-flex comment-header border-bottom border-secondary px-4 py-3">
                                      ...
                                      <div>
                                        <a href="#" class="comment-metadata text-success small">Aug 18, 2021 at 09:12 AM</a>
                                      </div>
                                    </div>
                                    <div class="p-4">
                                      <p class="small-2 mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam maximus lacus non tincidunt volutpat. Nullam volutpat mi nec nulla finibus tincidunt.</p>
                  ...
                  <div class="col-lg-5">
                    <div class="card bg-dark_A-20 border border-secondary mb-6">
                      <div class="px-4 pt-3"><span class="fw-600 ls-1 text-uppercase small-1"><span><i class="fas fa-history text-success mr-2"></i></span>Recent activity</span></div>
                      <div class="px-5 py-6">
                        <div class="mb-6">
                          <div class="row no-gutters">
                            <div class="col-2 item_img d-none d-sm-flex align-items-center">
                              <a href="store-product.php" class="product-item"><img class="img img-lg bl-3 text-primary" src="assets/img/content/store/h-08.jpg" alt="Games Store"></a>
                            </div>
                            <div class="col-6 item_content flex-1 flex-grow pl-0 pl-sm-3 pr-3">
                              <a href="store-product.php" class="product-item"><h6 class="item_title text-lt ls-1 small-1 fw-600 text-uppercase mb-0">Journey of the Solarcity</h6></a>
                              <span class="small-3"><span class="text-success"><i class="far fa-clock mr-1"></i></span>21:41</span>
                            </div>
                            <div class="col-6 col-sm-4">
                              <div class="row align-items-center justify-content-end h-100 no-gutters">
                                <div class="text-right small-3">
                                  <span class="fw-500"><span class="text-success">27</span> hrs total</span><br>
                                  <span class="fw-500">Last played <span class="text-success">Jul 29</span></span>
                                </div>
                              </div>
                            </div>
                          </div>
                        ...
                        <div class="mb-6">
                          <div class="row no-gutters">
                            <div class="col-2 item_img d-none d-sm-flex align-items-center">
                              <a href="store-product.php" class="product-item"><img class="img img-lg bl-3 text-primary" src="assets/img/content/store/h-10.jpg" alt="Games Store"></a>
                            </div>
                            <div class="col-6 item_content flex-1 flex-grow pl-0 pl-sm-3 pr-3">
                              <a href="store-product.php" class="product-item"><h6 class="item_title text-lt ls-1 small-1 fw-600 text-uppercase mb-0">Explosive: Blast</h6></a>
                              <span class="small-3"><span class="text-success"><i class="far fa-clock mr-1"></i></span>23:17</span>
                            </div>
                            <div class="col-6 col-sm-4">
                              <div class="row align-items-center justify-content-end h-100 no-gutters">
                                <div class="text-right small-3">
                                  <span class="fw-500"><span class="text-success">25</span> hrs total</span><br>
                                  <span class="fw-500">Last played <span class="text-success">Jul 27</span></span>
                                </div>
                              </div>
                            </div>
                          </div>
                        ...
                        <div class="mb-0">
                          <div class="row no-gutters">
                            <div class="col-2 item_img d-none d-sm-flex align-items-center">
                              <a href="store-product.php" class="product-item"><img class="img img-lg bl-3 text-primary" src="assets/img/content/store/h-02.jpg" alt="Games Store"></a>
                            </div>
                            <div class="col-6 item_content flex-1 flex-grow pl-0 pl-sm-3 pr-3">
                              <a href="store-product.php" class="product-item"><h6 class="item_title text-lt ls-1 small-1 fw-600 text-uppercase mb-0">Shadow Leap</h6></a>
                              <span class="small-3"><span class="text-success"><i class="far fa-clock mr-1"></i></span>16:25</span>
                            </div>
                            <div class="col-6 col-sm-4">
                              <div class="row align-items-center justify-content-end h-100 no-gutters">
                                <div class="text-right small-3">
                                  <span class="fw-500"><span class="text-success">12</span> hrs total</span><br>
                                  <span class="fw-500">Last played <span class="text-success">Jul 29</span></span>
                                </div>
                              </div>
                            </div>
                    ...
                    <div class="card bg-dark_A-20 border border-secondary">
                      <div class="px-4 pt-3"><span class="fw-600 ls-1 text-uppercase small-1"><span><i class="fas fa-users text-success mr-2"></i></span>Groups</span></div>
                      <div class="px-5 py-6">
                        <div class="mb-6">
                          <div class="row no-gutters">
                            <div class="col-2 item_img d-none d-sm-flex align-items-center">
                              <a href="store-product.php" class="product-item"><img class="img img-lg bl-3 text-primary" src="assets/img/content/store/h-01.jpg" alt="Games Store"></a>
                            </div>
                            <div class="col-12 col-sm-10 item_content flex-1 flex-grow pl-0 pl-sm-3 pr-3">
                              <a href="store-product.php" class="product-item"><h6 class="item_title text-lt ls-1 small-1 fw-600 text-uppercase mb-0">Creature 2020</h6></a>
                              <span class="small-3 fw-500">Members: <span class="text-success">45</span></span>
                            </div>
                          </div>
                        </div>
                        <div class="mb-0">
                          <div class="row no-gutters">
                            <div class="col-2 item_img d-none d-sm-flex align-items-center">
                              <a href="store-product.php" class="product-item"><img class="img img-lg bl-3 text-primary" src="assets/img/content/store/h-09.jpg" alt="Games Store"></a>
                            </div>
                            <div class="col-12 col-sm-10 item_content flex-1 flex-grow pl-0 pl-sm-3 pr-3">
                              <a href="store-product.php" class="product-item"><h6 class="item_title text-lt ls-1 small-1 fw-600 text-uppercase mb-0">Exploration Memories</h6></a>
                              <span class="small-3 fw-500">Members: <span class="text-success">31</span></span>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="row">
                        ...
                        <div class="product-item">
                          <div class="row align-items-center no-gutters">
                            <div class="item_img d-none d-sm-block">
                              <a href="store-product.php"><img class="img img-xl bl-3 text-primary" src="assets/img/content/store/h-07.jpg" alt="Games Store"></a>
                            </div>
                            <div class="item_content flex-1 flex-grow pl-0 pl-sm-6 pr-6">
                              <a href="store-product.php"><h6 class="item_title ls-1 small-1 fw-600 text-uppercase mb-1">Haku RE</h6></a>
                              <div class="mb-0">
                                <i class="mr-2 fab fa-windows"></i>
                                <i class="mr-2 fab fa-steam"></i>
                                <i class="fab fa-apple"></i>
                            ...
                            <div class="item_price">
                              <div class="row align-items-center h-100 no-gutters">
                                <div class="text-right">
                                  ...
                                  <span class="fw-600 lead-1 text-success">€44.99</span>
                                  <span class="small d-none d-sm-block fw-600">
                                      Added on 8/25/<span class="d-none d-lg-inline">20</span>19 ( <a href="#" class="text-dotted-success">remove</a> )
                                  </span>
                                </div>
                              </div>
                            </div>
                      ...
                      <div class="col-md-12 mb-4">
                        <div class="product-item">
                          <div class="row align-items-center no-gutters">
                            <div class="item_img d-none d-sm-block">
                              <a href="store-product.php"><img class="img img-xl bl-3 text-primary" src="assets/img/content/store/h-08.jpg" alt="Games Store"></a>
                            </div>
                            <div class="item_content flex-1 flex-grow pl-0 pl-sm-6 pr-6">
                              <a href="store-product.php"><h6 class="item_title ls-1 small-1 fw-600 text-uppercase mb-1">Journey of the Solarcity</h6></a>
                              <div class="mb-0">
                                <i class="mr-2 fab fa-windows"></i>
                                <i class="mr-2 fab fa-steam"></i>
                                <i class="fab fa-apple"></i>
                      ...
                      <div class="col-md-12 mb-4">
                        <div class="product-item">
                          <div class="row align-items-center no-gutters">
                            <div class="item_img d-none d-sm-block">
                              <a href="store-product.php"><img class="img img-xl bl-3 text-primary" src="assets/img/content/store/h-09.jpg" alt="Games Store"></a>
                            </div>
                            <div class="item_content flex-1 flex-grow pl-0 pl-sm-6 pr-6">
                              <a href="store-product.php"><h6 class="item_title ls-1 small-1 fw-600 text-uppercase mb-1">Exploration Memories</h6></a>
                              <div class="mb-0">
                                <i class="mr-2 fab fa-windows"></i>
                                <i class="mr-2 fab fa-steam"></i>
                                <i class="fab fa-apple"></i>
                      ...
                      <div class="col-md-12 mb-4">
                        <div class="product-item">
                          <div class="row align-items-center no-gutters">
                            <div class="item_img d-none d-sm-block">
                              <a href="store-product.php"><img class="img img-xl bl-3 text-primary" src="assets/img/content/store/h-01.jpg" alt="Games Store"></a>
                            </div>
                            <div class="item_content flex-1 flex-grow pl-0 pl-sm-6 pr-6">
                              <a href="store-product.php"><h6 class="item_title ls-1 small-1 fw-600 text-uppercase mb-1">Creature 2020</h6></a>
                              <div class="mb-0">
                                <i class="mr-2 fab fa-windows"></i>
                                <i class="mr-2 fab fa-steam"></i>
                                <i class="fab fa-apple"></i>
                      ...
                      <div class="col-md-12 mb-4">
                        <div class="product-item">
                          <div class="row align-items-center no-gutters">
                            <div class="item_img d-none d-sm-block">
                              <a href="store-product.php"><img class="img img-xl bl-3 text-primary" src="assets/img/content/store/h-10.jpg" alt="Games Store"></a>
                            </div>
                            <div class="item_content flex-1 flex-grow pl-0 pl-sm-6 pr-6">
                              <a href="store-product.php"><h6 class="item_title ls-1 small-1 fw-600 text-uppercase mb-1">Explosive: Blast</h6></a>
                              <div class="mb-0">
                                <i class="mr-2 fab fa-windows"></i>
                                <i class="mr-2 fab fa-steam"></i>
                                <i class="fab fa-apple"></i>
                    ...
                    <div class="filters border border-secondary rounded p-4">
                      <ul class="sidebar-nav-light-hover list-unstyled list-style-image mb-0 text-unset small-3 fw-600">
                        ...
                        <li class="nav-item text-light transition mt-4">
                          <a href="" class="btn btn-success d-block">Reset Filter</a>
                        </li>
                      </ul>
                    </div>
                  </div>
