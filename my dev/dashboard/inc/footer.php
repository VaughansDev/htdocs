...
<script src="<?php echo $_CONFIG['url']; ?>/assets/js/plugins/fullcalendar.min.js"></script>
...
<script src="<?php echo $_CONFIG['url']; ?>/assets/js/plugins/chartjs.min.js"></script>
<script src="<?php echo $_CONFIG['url']; ?>/assets/js/plugins/choices.min.js"></script>
<script src="<?php echo $_CONFIG['url']; ?>/assets/js/plugins/datatables.js"></script>
<script src="<?php echo $_CONFIG['url']; ?>/assets/js/plugins/multistep-form.js"></script>
<script>
