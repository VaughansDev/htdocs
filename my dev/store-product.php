              ...
              <header>
                ...
                <div class="d-flex flex-wrap align-items-center">
                  <div class="review d-flex">
                    ...
                    <div class="star_rating-se text-success mr-7">
                  ...
                  <ul class="tag-list d-none d-md-flex flex-wrap list-unstyled mb-0">
                    <li class="tag-item"><a href="" class="badge badge-success fw-600">Twitch Streams</a></li>
                    <li class="tag-item"><a href="" class="badge badge-success fw-600">Discussions</a></li>
                    <li class="tag-item"><a href="" class="text-unset release-date"><i class="far fa-clock text-success mr-1"></i> OCT 18 2021</a></li>
                  </ul>
                </div>
              </header>
            </div>
                ...
                <div class="col-12">
                  <div class="product-body">
                    ...
                    <div class="alert alert-no-border alert-share d-flex mb-6" role="alert">
                      <span class="flex-1 fw-600 text-uppercase text-success">Share:</span>
                          ...
                          <div class="tab-pane fade active show" id="fillup-1" role="tabpanel" aria-labelledby="fillup-home-tab">
                            <div class="row">
                              ...
                              <div class="col-xs-12 col-lg-6">
                                <div class="row">
                                  <div class="col-12">
                                    <span class="d-inline-block text-uppercase fw-500 mb-3 text-success">Recommended Requirements:</span>
                                  </div>
                                </div>
                                <div class="row mb-4 mb-sm-0">
                                  <div class="col-sm-4"><strong class="fw-500">OS:</strong></div>
	                                  ...
	                                  <div class="position-absolute w-100 l-0 b-0 bg-dark_A-80 text-light">
	                                    <div class="px-4 py-3 lh-1">
	                                      ...
	                                      <div class="price d-flex flex-wrap align-items-center">
	                                        <span class="discount_final text-success small-2">€99.99</span>
	                                      </div>
	                                    </div>
	                                  </div>
	                                </div>
              ...
              <div class="bg-dark_A-20 p-4 mb-4">
                ...
                <div class="price-wrapper">
                  ...
                  <div class="price-box mb-4">
                    ...
                    <div class="flex-1"><a href="" class="btn btn-block btn-success"><i class="fas fa-shopping-cart"></i> Add to Cart</a></div>
                  </div>
                </div>
                <div>
                	<div class="row mb-4">
              ...
              <div class="bg-dark_A-20 p-4">
                ...
                <ul class="list-unstyled mb-3">
                  <li>
                    ...
                    <span class="platform-item btn btn-sm btn-outline-success"><i class="fab fa-windows"></i> PC</span>
                    <span class="platform-item btn btn-sm btn-outline-success"><i class="fas fa-apple-alt"></i> mac</span>
                  </li>
                </ul>
                <ul class="list-unstyled mb-3">
                  ...
                  <li class="developer-wrapper">
                    ...
                    <div>
                      <div class="d-flex align-items-center">
                        ...
                        <span class="text-success ti-check"></span>
                      </div>
                      <hr class="my-2 border-secondary">
                      <div class="d-flex align-items-center">
        ...
        <div class="border border-secondary py-5 px-2">
          ...
          <div class="owl-carousel" data-carousel-items="1, 2, 3, 6">
            <div class="item mx-3">
              ...
              <span class="d-block small text-success"><i class="far fa-eye"></i> 23</span>
            </div>
            <div class="item mx-3">
              ...
              <span class="d-block small text-success"><i class="far fa-eye"></i> 57</span>
            </div>
            <div class="item mx-3">
                ...
                <div class="border border-secondary rounded p-4">
                  ...
                  <div class="review-item mb-5">
                    <div class="small d-flex">
                      <div class="flex-1">
                        <span class="name badge badge-success fw-600 small-4">metus</span>
