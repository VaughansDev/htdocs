                      ...
                      <form class="input-light w-100">
                        <div class="input-group input-transparent bg-transparent rounded">
                          ...
                          <div class="input-group-append ml-3">
                            <button class="btn btn-lg btn-success px-4" type="button" style="z-index: 1;"><i class="fas fa-comment-medical"></i></button>
                          </div>
                        </div>
                      </form>
                    </div>
                            ...
                            <div class="pl-4 pl-xl-0 pl-lp-4">
                              ...
                              <div class="d-flex">
                                <div class="ml-auto position-relative">
                                  <div class="chat-dialogue-avatar-st position-relative bg-success text-secondary">12+</div>
                                </div>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="chat-dialogue-sc sVHF">
                            <ul class="chat-list-section list-unstyled text-center py-4 pr-xl-6 mb-0">
                              ...
                              <li class="text-left fw-500 mb-6">
                                ...
                                <span class="text-light fw-300 o-80">Welcome to the beginning of the <a href="profile.php" class="fw-600">@Qiretha</a> group.</span>
                              </li>
                              <!-- /.welcome -->
                              <!-- time -->
                        ...
                        <div id="sVHF_form" class="chat-ct-form pr-4 pr-xl-0 pl-4 pt-4">
                          <form class="msg-snd input-light">
                            <div class="input-group input-transparent bg-transparent">
                              ...
                              <div class="input-group-append ml-3">
                                <button class="btn btn-lg btn-success px-4" type="button"><i class="fas fa-paper-plane mr-1"></i></button>
                              </div>
                            </div>
                          </form>
                        </div>
