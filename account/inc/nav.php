            ...
            <ul class="kd-nav kd-nav-align-right">
                <li class="kd-nav-item kd-nav-item-drop">
                    <a class="kd-nav-icon" href="#" role="button">
                        ...
                        <img class="icon" width="22" src="<?php echo $_CONFIG['accounturl']; ?>/assets/images/icon-bag.svg">
                    </a>
                            ...
                            <tbody>
                                <tr>
                                    <th scope="row" class="kd-table-checkout-img">
                                        <a href="product.php"><img src="<?php echo $_CONFIG['accounturl']; ?>/assets/images/product-1-sm.png" alt=""></a>
                                    </th>
                                ...
                                <tr>
                                    <th scope="row" class="kd-table-checkout-img">
                                        <a href="product.php"><img src="<?php echo $_CONFIG['accounturl']; ?>/assets/images/product-2-sm.png" alt=""></a>
                                    </th>
                                    <td class="kd-table-checkout-title">
