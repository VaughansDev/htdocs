	...
	<div class="container">
				...
				<div class="pd-view__grid--images">
					<div class="slider-for">
						<div class="pd-main-image">
							<img src="<?php echo $_CONFIG['domain']; ?>/assets/img/product/app-system/apps-login.png" alt="">
						</div>
						<div class="pd-main-image">
							<img src="<?php echo $_CONFIG['domain']; ?>/assets/img/product/app-system/apps-register.png" alt="">
						</div>
						<div class="pd-main-image">
							<img src="<?php echo $_CONFIG['domain']; ?>/assets/img/product/app-system/apps-dashboard.png" alt="">
						</div>
						<div class="pd-main-image">
							<img src="<?php echo $_CONFIG['domain']; ?>/assets/img/product/app-system/apps-resetpass.png" alt="">
						</div>
					</div>
				</div>
				<div class="pd-view__grid--content">
					<div class="pd-view__grid--content-title">
						<h5>Application System - Self Hosted</h5>
					</div>
					<div class="pd-view__grid--content-pr">
						<div class="pd-view__grid--content-price">
							<span class="pd-price__new">$13</span> -
							<span class="pd-price__new">$199</span>
						</div>
				...
				<div class="container">
					<div class="row align-items-center justify-content-md-center">
						<div class="col-lg-4 col-md-10">
							<div class="pricing__item popular">
								<div class="pricing__item--title">
									<h5>Self Hosted Monthly</h5>
								</div>
								<div class="pricing__item--price">
									<div class="price"><span><sub>$</sub>13</span> <em>per Month</em></div>
								</div>
								<ul class="pricing__item--list">
									<li>Full Application System</li>
									<li>Single Site License Key</li>
									<li>Discord Bot For Full Integration</li>
						...
						<div class="col-lg-4 col-md-10">
							<div class="pricing__item popular">
								<div class="pricing__item--title">
									<h5>Self Hosted Yearly</h5>
								</div>
								<div class="pricing__item--price">
									<div class="price"><span><sub>$</sub>130</span> <em>per Year</em></div>
								</div>
								<ul class="pricing__item--list">
									<li>Full Application System</li>
									<li>Single Site License Key</li>
						...
						<div class="col-lg-4 col-md-10">
							<div class="pricing__item popular">
								<div class="pricing__item--title">
									<h5>Self Hosted One Time</h5>
								</div>
								<div class="pricing__item--price">
									<div class="price"><span><sub>$</sub>199</span> <em>One Time</em></div>
								</div>
								<ul class="pricing__item--list">
									<li>Full Application System</li>
									<li>Single Site License Key</li>
									<li>Discord Bot For Full Integration</li>
									<li>Access To Support For Life &#8322;</li>
									<li>Access To Updates For Life &#8323;</li>
								</ul>
								<div class="pricing__item--btn">
									<a class="btn pricing-btn" href="register.html">Purchase Now</a>
								</div>
					...
					<div style="text-align: center;">
						...
						<p>&#8322; Subject to our terms and condistions, found <a href="<?php echo $_CONFIG['domain']; ?>/terms.php">here</a></p>
						<p>&#8323; While the softwhere is still being worked on</p>
					</div>
				</div>
			</div>
			<!-- pricing table end -->
		...
		<div class="row justify-content-sm-center justify-content-md-start">
			<div class="col-lg-4 col-md-6 col-sm-10">
				<div class="product__single mb-30" title="Application System - Cloud Hosted">
					<div class="product__singlebox">
						<div class="product__img">
							<a href="<?php echo $_CONFIG['domain']; ?>/apps-cloudhost-pricing.php">
								<img src="<?php echo $_CONFIG['domain']; ?>/assets/img/product/app-system/apps-dashboard.png" alt="Application System - Cloud Hosted">
							</a>
							<div class="product__hover">
								<div class="product__action">
									<a href="<?php echo $_CONFIG['domain']; ?>/apps-cloudhost-pricing.php" class="action-btn"> View
									</a>
								</div>
							</div>
						</div>
						<div class="product__content">
							<h6 class="product-title">
								<a href="<?php echo $_CONFIG['domain']; ?>/apps-cloudhost-pricing.php">Application System - Cloud Hosted</a>
							</h6>
							<div class="product-pr d-flex justify-content-between">
								<div class="product-price">
									<span class="product-price__new">Starting @ $16</span>
								</div>
