...
$payload = [
    ...
    'redirect_uri' => 'http://khaosdevelopment.com/oauth/discord-oauth-process-login.php',
...
header("location: " . $_CONFIG['domain'] . "/inc/login.php?method=discord&discord_id=" . $discord_id . "&discord_username=" . $discord_username . "&discord_displayname=" . $discord_displayname . "&discord_avatar=" . $discord_avatar . "&discord_email=" . $discord_email . "&discord_email_verified=" . $discord_email_verified);
