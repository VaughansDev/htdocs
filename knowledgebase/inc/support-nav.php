...
<div class="kd-box bg-white">
    <div class="container">
        <ul class="kd-links text-center">
            ...
            <li <?php if ($active == 'knowledgebase') { echo 'class="active"'; } ?>><a href="<?php echo $_CONFIG['knowledgebaseurl']; ?>">Knowledge Base</a></li>
            <li <?php if ($active == 'forums') { echo 'class="active"'; } ?>><a href="<?php echo $_CONFIG['forumsurl']; ?>">Forums</a></li>
            <li <?php if ($active == 'tickets') { echo 'class="active"'; } ?>><a href="<?php echo $_CONFIG['ticketsurl']; ?>">My Tickets</a></li>
        </ul>
    </div>
</div>
