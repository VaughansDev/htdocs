...
<div class="kd-main">
    ...
    <div class="kd-box-1 pb-100 bg-grey-6">
        <div class="container">
                ...
                <div class="col-lg-8">
                    <div class="kd-blog-post kd-box kd-box-decorated">
                        ...
                        <div class="kd-blog-post-box">
                            <h1 class="h3 kd-blog-post-title"><a href="single-post.php">The Big Thing in Design</a></h1>
                            <ul class="kd-blog-post-info">
                                <li>Date: 25 Sep 2018</li>
                                <li>Views: 124</li>
                                <li>Category: <ul class="kd-blog-post-categories">
                                        <li><a href="#">News</a></li>
                                    </ul>
                                </li>
                        ...
                        <div class="kd-blog-post-box">
                            <blockquote class="kd-blockquote mnt-10 mb-0"> Fruit male face green be also darkness meat sixth shall all Fish. Hath creature. Sea all creepeth first which creepeth without gathered us deep. </blockquote>
                        </div>
                        <div class="kd-blog-post-box">
                        ...
                        <div class="kd-blog-post-box">
                            ...
                            <ul class="kd-blog-post-list mnb-7">
                                <li>Theme Style</li>
                                <li>Fonts</li>
                                <li>Navigation</li>
                                <li>Single Page</li>
                        ...
                        <div class="kd-blog-post-box pt-30 pb-30">
                            <ul class="kd-blog-post-tags mnt-6 mnb-1 db">
                                <li class="kd-blog-post-tags-title">Tags:</li>
                ...
                <div class="col-lg-4">
                    <div class="kd-sticky kd-sidebar" data-sticky-offsetTop="120" data-sticky-offsetBot="40">
                        ...
                        <div class="kd-widget kd-box kd-box-decorated">
                            <div class="kd-widget-title">Categories</div>
                        ...
                        <div class="kd-widget kd-box kd-box-decorated">
                            <div class="kd-widget-title"> Tags Widget </div>
                            <ul class="kd-widget-tags">
                                <li><a href="#">Art</a></li>
                                <li><a href="#">People</a></li>
                                <li><a href="#">Branding</a></li>
                                <li><a href="#">City</a></li>
                        ...
                        <div class="kd-widget kd-box kd-box-decorated">
                            <div class="kd-widget-title"> Our Twitter </div>
                            <div class="kd-twitter-list" data-twitter-count="3"></div>
                        </div>
                    </div>
                </div>
            </div>
