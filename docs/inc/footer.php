                    ...
                    <div class="kd-widget-footer">
                        <div class="kd-widget-title">
                            <a href="index-2.php" class="kd-widget-logo">
                                <img src="<?php echo $_CONFIG['docsurl']; ?>/assets/images/logo.png" alt="" width="88px">
                            </a>
                        </div>
...
<div id="subscribe" class="kd-popup kd-popup-modal kd-popup-subscribe">
    ...
    <div class="kd-box kd-box-decorated">
        ...
        <div class="kd-box-content">
            ...
            <form action="<?php echo $_CONFIG['docsurl']; ?>/inc/mailinglist.php" method="post" class="kd-form kd-form-group-inputs">
...
<!-- START: Scripts -->
<!-- Object Fit Images -->
<script src="<?php echo $_CONFIG['docsurl']; ?>/assets/vendor/object-fit-images/dist/ofi.min.js"></script>
<!-- Popper -->
<script src="<?php echo $_CONFIG['docsurl']; ?>/assets/vendor/popper.js/dist/umd/popper.min.js"></script>
<!-- Bootstrap -->
<script src="<?php echo $_CONFIG['docsurl']; ?>/assets/vendor/bootstrap/dist/js/bootstrap.min.js"></script>
<!-- Fancybox -->
<script src="<?php echo $_CONFIG['docsurl']; ?>/assets/vendor/fancybox/dist/jquery.fancybox.min.js"></script>
<!-- Cleave -->
<script src="<?php echo $_CONFIG['docsurl']; ?>/assets/vendor/cleave.js/dist/cleave.min.js"></script>
<!-- Validator -->
<script src="<?php echo $_CONFIG['docsurl']; ?>/assets/vendor/validator/validator.min.js"></script>
<!-- Sticky Kit -->
<script src="<?php echo $_CONFIG['docsurl']; ?>/assets/vendor/sticky-kit/dist/sticky-kit.min.js"></script>
<!-- Jarallax -->
<script src="<?php echo $_CONFIG['docsurl']; ?>/assets/vendor/jarallax/dist/jarallax.min.js"></script>
<script src="<?php echo $_CONFIG['docsurl']; ?>/assets/vendor/jarallax/dist/jarallax-video.min.js"></script>
<!-- Isotope -->
<script src="<?php echo $_CONFIG['docsurl']; ?>/assets/vendor/isotope-layout/dist/isotope.pkgd.min.js"></script>
<!-- ImagesLoaded -->
<script src="<?php echo $_CONFIG['docsurl']; ?>/assets/vendor/imagesloaded/imagesloaded.pkgd.min.js"></script>
<!-- Swiper -->
<script src="<?php echo $_CONFIG['docsurl']; ?>/assets/vendor/swiper/swiper-bundle.min.js"></script>
<!-- Gist Embed -->
<script src="<?php echo $_CONFIG['docsurl']; ?>/assets/vendor/gist-embed/dist/gist-embed.min.js"></script>
<!-- Bootstrap Select -->
<script src="<?php echo $_CONFIG['docsurl']; ?>/assets/vendor/bootstrap-select/dist/js/bootstrap-select.min.js"></script>
<!-- Dropzone -->
<script src="<?php echo $_CONFIG['docsurl']; ?>/assets/vendor/dropzone/dist/min/dropzone.min.js"></script>
<!-- Quill -->
<script src="<?php echo $_CONFIG['docsurl']; ?>/assets/vendor/quill/dist/quill.min.js"></script>
<!-- The Amdesk -->
<script src="<?php echo $_CONFIG['docsurl']; ?>/assets/js/khaos.min.css"></script>
<script src="<?php echo $_CONFIG['docsurl']; ?>/assets/js/khaos-init.js"></script>
<!-- END: Scripts -->
</body>
