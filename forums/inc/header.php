...
<head>
    ...
    <!-- Font Awesome -->
    <script defer src="<?php echo $_CONFIG['domain']; ?>/assets/vendor/fontawesome-free/js/all.js"></script>
    <script defer src="<?php echo $_CONFIG['domain']; ?>/assets/vendor/fontawesome-free/js/v4-shims.js"></script>
    <!-- Amdesk -->
