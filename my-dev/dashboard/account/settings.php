      ...
      <div class="col-lg-4 col-sm-8">
        <div class="nav-wrapper position-relative end-0">
          <ul class="nav nav-pills nav-fill p-1" role="tablist">
            <li class="nav-item">
              <a class="nav-link mb-0 px-0 py-1 active  active " data-bs-toggle="tab" href="https://demos.creative-tim.com/argon-dashboard-pro/examples/pages/account/settings.html" role="tab" aria-selected="true">
                Messages
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link mb-0 px-0 py-1 " data-bs-toggle="tab" href="https://demos.creative-tim.com/argon-dashboard-pro/examples/pages/account/billing.html" role="tab" aria-selected="false">
                Social
              </a>
            </li>
            <li class="nav-item">
    ...
    <div class="row mb-5">
      ...
      <div class="col-lg-9 mt-lg-0 mt-4">
        ...
        <div class="card mt-4" id="accounts">
          ...
          <div class="card-body pt-0">
            <div class="d-flex">
              <img class="width-48-px" src="https://demos.creative-tim.com/argon-dashboard-pro/assets/img/small-logos/logo-slack.svg" alt="logo_slack">
            ...
            <div class="ps-5 pt-3 ms-3">
              ...
              <div class="d-sm-flex bg-gray-100 border-radius-lg p-2 my-4">
                ...
                <h6 class="text-sm ms-auto me-3 my-auto"><a href="https://demos.creative-tim.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="1e767b7272715e7d6c7b7f6a77687b336a7773307d7173">[email&#160;protected]</a></h6>
                <button class="btn btn-sm bg-gradient-danger my-sm-auto mt-2 mb-0" type="button" name="button">Delete</button>
              </div>
            </div>
            <hr class="horizontal dark">
            <div class="d-flex">
              <img class="width-48-px" src="https://demos.creative-tim.com/argon-dashboard-pro/assets/img/small-logos/logo-spotify.svg" alt="logo_spotify">
              <div class="my-auto ms-3">
                <div class="h-100">
            ...
            <hr class="horizontal dark">
            <div class="d-flex">
              <img class="width-48-px" src="https://demos.creative-tim.com/argon-dashboard-pro/assets/img/small-logos/logo-atlassian.svg" alt="logo_atlassian">
              <div class="my-auto ms-3">
                <div class="h-100">
            ...
            <hr class="horizontal dark">
            <div class="d-flex">
              <img class="width-48-px" src="https://demos.creative-tim.com/argon-dashboard-pro/assets/img/small-logos/logo-asana.svg" alt="logo_asana">
              <div class="my-auto ms-3">
                <div class="h-100">
