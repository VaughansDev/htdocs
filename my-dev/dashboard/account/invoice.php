    ...
    <div class="container-fluid py-1 px-3">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
          ...
          <li class="breadcrumb-item text-sm text-white active" aria-current="page">Invoice</li>
        </ol>
        <h6 class="font-weight-bolder text-white">Invoice</h6>
      </nav>
      ...
      <div class="col-lg-4 col-sm-8">
        <div class="nav-wrapper position-relative end-0">
          <ul class="nav nav-pills nav-fill p-1" role="tablist">
            ...
            <li class="nav-item">
              <a class="nav-link mb-0 px-0 py-1  active " data-bs-toggle="tab" href="https://demos.creative-tim.com/argon-dashboard-pro/examples/pages/account/invoice.html" role="tab" aria-selected="false">
                Notifications
              </a>
            </li>
            <li class="nav-item">
  ...
  <div class="container-fluid my-5 py-2">
    <div class="row">
      <div class="col-md-8 col-sm-10 mx-auto">
        <form class action="https://demos.creative-tim.com/argon-dashboard-pro/pages/pages/account/index.html" method="post">
              ...
              <div class="row">
                <div class="col-lg-5 text-left">
                  ...
                  <h6 class="text-secondary mb-0">
                    email:
                    <span class="text-dark"><a href="https://demos.creative-tim.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="7d0e080d0d120f093d1e0f181c09140b1850091410531e1210">[email&#160;protected]</a></span>
                  </h6>
                </div>
                <div class="col-lg-7 text-md-end mt-md-0 mt-3">
                  <button class="btn btn-primary mt-lg-7 mb-0" onClick="window.print()" type="button" name="button">Print</button>
                </div>
              </div>
            </div>
          </div>
