...
<meta property="og:url" content="../dashboards/landing-2.html" />
...
<link id="pagestyle" href="../../assets/css/argon-dashboard.min9c7f.css?v=2.0.5" rel="stylesheet" />
</head>
<body class="g-sidenav-show   bg-gray-100"><nav class="navbar navbar-expand-lg position-absolute top-0 z-index-3 w-100 shadow-none my-3 navbar-transparent mt-4">
<div class="container ps-2 pe-0">
<a class="navbar-brand font-weight-bolder ms-lg-0 ms-3 text-white" href="../dashboards/default.html">
...
Pages
<img src="https://demos.creative-tim.com/argon-dashboard-pro/assets/img/down-arrow-white.svg" alt="down-arrow" class="arrow ms-1 d-lg-block d-none">
...
<a href="../dashboards/virtual-reality.html" class="dropdown-item border-radius-md">
...
<a href="profile/teams.html" class="dropdown-item border-radius-md">
...
<a href="../dashboards/virtual-reality.html" class="dropdown-item border-radius-md ms-3">
Virtual Reality
</a>
...
<a href="users/reports.html" class="dropdown-item border-radius-md ms-3">
Reports
</a>
<a href="users/new-user.html" class="dropdown-item border-radius-md ms-3">
New user
</a>
<div class="dropdown-header text-dark font-weight-bolder d-flex align-items-center px-0 mt-3">
<i class="ni ni-badge me-3 text-primary"></i>
...
<a href="profile/overview.html" class="dropdown-item border-radius-md ms-3">
Overview
</a>
<a href="profile/teams.html" class="dropdown-item border-radius-md ms-3">
Teams
</a>
<a href="profile/projects.html" class="dropdown-item border-radius-md ms-3">
Projects
</a>
<div class="dropdown-header text-dark font-weight-bolder d-flex align-items-center mt-3 px-0">
<i class="ni ni-app me-3 text-primary"></i>
...
<a href="projects/general.html" class="dropdown-item border-radius-md ms-3">
General
</a>
<a href="projects/timeline.html" class="dropdown-item border-radius-md ms-3">
Timeline
</a>
<a href="projects/new-project.html" class="dropdown-item border-radius-md ms-3">
New Project
</a>
<div class="dropdown-header text-dark font-weight-bolder d-flex align-items-center mt-3 px-0">
<i class="ni ni-single-02 me-3 text-primary"></i>
...
<a href="account/settings.html" class="dropdown-item border-radius-md ms-3">
Settings
</a>
<a href="account/billing.html" class="dropdown-item border-radius-md ms-3">
Billing
</a>
<a href="account/invoice.html" class="dropdown-item border-radius-md ms-3">
Invoice
</a>
<a href="account/security.html" class="dropdown-item border-radius-md ms-3">
Security
</a>
<div class="dropdown-header text-dark font-weight-bolder d-flex align-items-center mt-3 px-0">
<i class="ni ni-folder-17 me-3 text-primary"></i>
...
<a href="pricing-page.html" class="dropdown-item border-radius-md ms-3">
Pricing Page
</a>
<a href="rtl-page.html" class="dropdown-item border-radius-md ms-3">
RTL Page
</a>
<a href="widgets.html" class="dropdown-item border-radius-md ms-3">
Widgets
</a>
</div>
</div>
...
<a class="dropdown-item ps-3 border-radius-md mb-1" href="../authentication/signin/illustration.html">
...
<a class="dropdown-item ps-3 border-radius-md mb-1" href="../authentication/signup/illustration.html">
<span>Illustration</span>
</a>
</div>
</li>
...
<a class="dropdown-item ps-3 border-radius-md mb-1" href="../authentication/reset/illustration.html">
<span>Illustration</span>
</a>
</div>
</li>
...
<a class="dropdown-item ps-3 border-radius-md mb-1" href="../authentication/lock/illustration.html">
<span>Illustration</span>
</a>
</div>
</li>
...
<a class="dropdown-item ps-3 border-radius-md mb-1" href="../authentication/verification/illustration.html">
<span>Illustration</span>
</a>
</div>
</li>
...
<a class="dropdown-item ps-3 border-radius-md mb-1" href="../authentication/error/500.html">
<span>500</span>
</a>
</div>
</li>
...
<a href="../authentication/signin/basic.html" class="dropdown-item border-radius-md">
Basic
</a>
<a href="../authentication/signin/cover.html" class="dropdown-item border-radius-md">
Cover
</a>
<a href="../authentication/signin/illustration.html" class="dropdown-item border-radius-md">
Illustration
</a>
<h6 class="dropdown-header text-dark font-weight-bolder d-flex align-items-center mt-3 px-0">
Sign Up
</h6>
<a href="../authentication/signup/basic.html" class="dropdown-item border-radius-md">
Basic
</a>
<a href="../authentication/signup/cover.html" class="dropdown-item border-radius-md">
Cover
</a>
<a href="../authentication/signup/illustration.html" class="dropdown-item border-radius-md">
Illustration
</a>
<h6 class="dropdown-header text-dark font-weight-bolder d-flex align-items-center mt-3 px-0">
Reset Password
</h6>
<a href="../authentication/reset/basic.html" class="dropdown-item border-radius-md">
Basic
</a>
<a href="../authentication/reset/cover.html" class="dropdown-item border-radius-md">
Cover
</a>
<a href="../authentication/reset/illustration.html" class="dropdown-item border-radius-md">
Illustation
</a>
<h6 class="dropdown-header text-dark font-weight-bolder d-flex align-items-center mt-3 px-0">
Lock
</h6>
<a href="../authentication/lock/basic.html" class="dropdown-item border-radius-md">
Basic
</a>
<a href="../authentication/lock/cover.html" class="dropdown-item border-radius-md">
Cover
</a>
<a href="../authentication/lock/illustration.html" class="dropdown-item border-radius-md">
Illustration
</a>
<h6 class="dropdown-header text-dark font-weight-bolder d-flex align-items-center mt-3 px-0">
2-Step Verification
</h6>
<a href="../authentication/verification/basic.html" class="dropdown-item border-radius-md">
Basic
</a>
<a href="../authentication/verification/cover.html" class="dropdown-item border-radius-md">
Cover
</a>
<a href="../authentication/verification/illustration.html" class="dropdown-item border-radius-md">
Illustration
</a>
<h6 class="dropdown-header text-dark font-weight-bolder d-flex align-items-center mt-3 px-0">
Error
</h6>
<a href="../authentication/error/404.html" class="dropdown-item border-radius-md">
404
</a>
<a href="../authentication/error/500.html" class="dropdown-item border-radius-md">
500
</a>
</div>
</div>
...
<a href="orders/details.html" class="dropdown-item border-radius-md ms-3">
Order Details
</a>
<div class="dropdown-header text-dark font-weight-bolder d-flex align-items-center px-0 mt-3">
<i class="ni ni-box-2 text-primary me-3"></i>
...
<li class="nav-item">
<a href="javascript:;" class="btn btn-sm  bg-white  mb-0 me-1" onclick="smoothToPricing('pricing-argon')">Buy Now</a>
</li>
</ul>
</div>
</div>
...
<div class="page-header position-relative" style="background-image: url('../../assets/img/pricing-header-bg.jpg');
...
<span class="text-uppercase font-weight-bold text-dark">Starter</span>
...
<div class="card">
<div class="card-header text-center pt-4 pb-3">
<span class="text-uppercase font-weight-bold text-dark">Premium</span>
<h1 class="font-weight-bold mt-2">
<small>$</small>89
</h1>
</div>
...
<a href="javascript:;" class="btn btn-icon btn-primary d-lg-block mt-3 mb-0">
Try Premium
<i class="fas fa-arrow-right ms-1"></i>
</a>
</div>
...
<div class="card">
<div class="card-header text-center pt-4 pb-3">
<span class="text-uppercase font-weight-bold text-dark">Enterprise</span>
<h1 class="font-weight-bold mt-2">
<small>$</small>99
</h1>
</div>
...
<img class="w-100 opacity-9" src="https://demos.creative-tim.com/argon-dashboard-pro/assets/img/logos/gray-logos/logo-coinbase.svg" alt="logo_coinbase">
</div>
<div class="col-lg-2 col-md-4 col-6 mb-4">
<img class="w-100 opacity-9" src="https://demos.creative-tim.com/argon-dashboard-pro/assets/img/logos/gray-logos/logo-nasa.svg" alt="logo_nasa">
</div>
<div class="col-lg-2 col-md-4 col-6 mb-4">
<img class="w-100 opacity-9" src="https://demos.creative-tim.com/argon-dashboard-pro/assets/img/logos/gray-logos/logo-netflix.svg" alt="logo_netflix">
</div>
<div class="col-lg-2 col-md-4 col-6 mb-4">
<img class="w-100 opacity-9" src="https://demos.creative-tim.com/argon-dashboard-pro/assets/img/logos/gray-logos/logo-pinterest.svg" alt="logo_pinterest">
</div>
<div class="col-lg-2 col-md-4 col-6 mb-4">
<img class="w-100 opacity-9" src="https://demos.creative-tim.com/argon-dashboard-pro/assets/img/logos/gray-logos/logo-spotify.svg" alt="logo_spotify">
</div>
<div class="col-lg-2 col-md-4 col-6 mb-4">
<img class="w-100 opacity-9" src="https://demos.creative-tim.com/argon-dashboard-pro/assets/img/logos/gray-logos/logo-vodafone.svg" alt="logo_vodafone">
</div>
</div>
<div class="row mt-8">
<div class="col-md-6 mx-auto text-center">
