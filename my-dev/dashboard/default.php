...
<a href="../signin/illustration.html" class="nav-link text-white font-weight-bold px-0" target="_blank">
...
<div class="d-flex py-1">
<div class="my-auto">
<img src="<?php echo $_CONFIG['url']; ?>/argon-dashboard-pro/assets/img/small-logos/logo-spotify.svg" class="avatar avatar-sm bg-gradient-dark  me-3 " alt="logo spotify">
</div>
<div class="d-flex flex-column justify-content-center">
<h6 class="text-sm font-weight-normal mb-1">
...
<div class="carousel-item h-100 active" style="background-image: url('<?php echo $_CONFIG['url']; ?>/assets/img/img-2.jpg');
...
<div class="carousel-item h-100" style="background-image: url('<?php echo $_CONFIG['url']; ?>/assets/img/img-1.jpg');
      background-size: cover;">
<div class="carousel-caption d-none d-md-block bottom-0 text-start start-0 ms-5">
<div class="icon icon-shape icon-sm bg-white text-center border-radius-md mb-3">
...
<div class="carousel-item h-100" style="background-image: url('<?php echo $_CONFIG['url']; ?>/assets/img/img-3.jpg');
      background-size: cover;">
<div class="carousel-caption d-none d-md-block bottom-0 text-start start-0 ms-5">
<div class="icon icon-shape icon-sm bg-white text-center border-radius-md mb-3">
...
<img class="border-radius-lg" alt="Image placeholder" src="<?php echo $_CONFIG['url']; ?>/assets/img/team-1.jpg">
</a>
</div>
<div class="col ml-2">
<h6 class="mb-0">
...
<div class="col-auto d-flex align-items-center">
<a href="javascript:;" class="avatar">
<img class="border-radius-lg" alt="Image placeholder" src="<?php echo $_CONFIG['url']; ?>/assets/img/team-2.jpg">
</a>
</div>
<div class="col ml-2">
<h6 class="mb-0">
...
<div class="col-auto d-flex align-items-center">
<a href="javascript:;" class="avatar">
<img class="border-radius-lg" alt="Image placeholder" src="<?php echo $_CONFIG['url']; ?>/assets/img/team-5.jpg">
</a>
</div>
<div class="col ml-2">
<h6 class="mb-0">
...
<div class="col-auto d-flex align-items-center">
<a href="javascript:;" class="avatar">
<img class="border-radius-lg" alt="Image placeholder" src="<?php echo $_CONFIG['url']; ?>/assets/img/team-4.jpg">
</a>
</div>
<div class="col ml-2">
<h6 class="mb-0">
...
<img alt="Image placeholder" src="<?php echo $_CONFIG['url']; ?>/argon-dashboard-pro/assets/img/small-logos/logo-jira.svg">
</a>
</div>
<div class="col">
...
<div class="col-auto">
<a href="javascript:;" class="avatar rounded-circle">
<img alt="Image placeholder" src="<?php echo $_CONFIG['url']; ?>/argon-dashboard-pro/assets/img/small-logos/logo-asana.svg">
</a>
</div>
<div class="col">
...
<div class="col-auto">
<a href="javascript:;" class="avatar rounded-circle">
<img alt="Image placeholder" src="<?php echo $_CONFIG['url']; ?>/argon-dashboard-pro/assets/img/small-logos/logo-spotify.svg">
</a>
</div>
<div class="col">
...
<div class="col-auto">
<a href="javascript:;" class="avatar rounded-circle">
<img alt="Image placeholder" src="<?php echo $_CONFIG['url']; ?>/argon-dashboard-pro/assets/img/small-logos/bootstrap.svg">
</a>
</div>
<div class="col">
...
<a href="javascript:;">
<img src="<?php echo $_CONFIG['url']; ?>/assets/img/team-4.jpg" class="avatar" alt="profile-image">
</a>
<div class="mx-3">
...
<img alt="Image placeholder" src="<?php echo $_CONFIG['url']; ?>/raw.githubusercontent.com/creativetimofficial/public-assets/master/argon-dashboard-pro/assets/img/activity-feed.jpg" class="img-fluid border-radius-lg shadow-lg max-height-500">
...
<img alt="Image placeholder" src="<?php echo $_CONFIG['url']; ?>/assets/img/team-5.jpg" class>
</a>
...
<img alt="Image placeholder" src="<?php echo $_CONFIG['url']; ?>/assets/img/team-1.jpg" class="rounded-circle">
</a>
</div>
...
<img alt="Image placeholder" class="avatar rounded-circle" src="<?php echo $_CONFIG['url']; ?>/assets/img/bruce-mars.jpg">
</div>
...
<div class="flex-shrink-0">
<img alt="Image placeholder" class="avatar rounded-circle" src="<?php echo $_CONFIG['url']; ?>/assets/img/team-5.jpg">
</div>
<div class="flex-grow-1 ms-3">
...
<div class="flex-shrink-0">
<img alt="Image placeholder" class="avatar rounded-circle me-3" src="<?php echo $_CONFIG['url']; ?>/assets/img/team-4.jpg">
</div>
...
<div>
<img src="<?php echo $_CONFIG['url']; ?>/soft-ui-design-system-pro/assets/img/logos/small-logos/logo-spotify.svg" class="avatar avatar-sm rounded-circle me-2">
</div>
<div class="my-auto">
...
<div class="d-flex px-2">
<div>
<img src="<?php echo $_CONFIG['url']; ?>/soft-ui-design-system-pro/assets/img/logos/small-logos/logo-invision.svg" class="avatar avatar-sm rounded-circle me-2">
</div>
<div class="my-auto">
...
<div class="d-flex px-2">
<div>
<img src="<?php echo $_CONFIG['url']; ?>/soft-ui-design-system-pro/assets/img/logos/small-logos/logo-jira.svg" class="avatar avatar-sm rounded-circle me-2">
</div>
<div class="my-auto">
...
<div class="d-flex px-2">
<div>
<img src="<?php echo $_CONFIG['url']; ?>/soft-ui-design-system-pro/assets/img/logos/small-logos/logo-slack.svg" class="avatar avatar-sm rounded-circle me-2">
</div>
<div class="my-auto">
...
<div class="d-flex px-2">
<div>
<img src="<?php echo $_CONFIG['url']; ?>/soft-ui-design-system-pro/assets/img/logos/small-logos/logo-webdev.svg" class="avatar avatar-sm rounded-circle me-2">
</div>
<div class="my-auto">
...
<div class="d-flex px-2">
<div>
<img src="<?php echo $_CONFIG['url']; ?>/soft-ui-design-system-pro/assets/img/logos/small-logos/logo-xd.svg" class="avatar avatar-sm rounded-circle me-2">
</div>
<div class="my-auto">
...
<div class="col">
<img src="<?php echo $_CONFIG['url']; ?>/assets/img/logos/bitcoin.jpg" class="w-30 border-radius-md" alt="Image placeholder">
</div>
<div class="col-auto">
...
<div>
<img src="<?php echo $_CONFIG['url']; ?>/assets/img/icons/flags/US.png" alt="Country flag">
</div>
<div class="ms-4">
...
<div class="d-flex px-2 py-1 align-items-center">
<div>
<img src="<?php echo $_CONFIG['url']; ?>/assets/img/icons/flags/DE.png" alt="Country flag">
</div>
<div class="ms-4">
<p class="text-xs font-weight-bold mb-0">Country:</p>
...
<div class="d-flex px-2 py-1 align-items-center">
<div>
<img src="<?php echo $_CONFIG['url']; ?>/assets/img/icons/flags/GB.png" alt="Country flag">
</div>
<div class="ms-4">
<p class="text-xs font-weight-bold mb-0">Country:</p>
...
<div class="d-flex px-2 py-1 align-items-center">
<div>
<img src="<?php echo $_CONFIG['url']; ?>/assets/img/icons/flags/BR.png" alt="Country flag">
</div>
<div class="ms-4">
<p class="text-xs font-weight-bold mb-0">Country:</p>
...
<p class="text-xs text-secondary mb-0"><a href="<?php echo $_CONFIG['url']; ?>/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="e08a8f888ea08392858194899685cd94898dce838f8d">[email&#160;protected]</a></p>
</div>
</div>
</td>
<td>
...
<p class="text-xs text-secondary mb-0"><a href="<?php echo $_CONFIG['url']; ?>/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="c8a9a4adb0a988abbaada9bca1beade5bca1a5e6aba7a5">[email&#160;protected]</a></p>
</div>
</div>
</td>
<td>
...
<p class="text-xs text-secondary mb-0"><a href="<?php echo $_CONFIG['url']; ?>/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="e78b869295828993a784958286938e9182ca938e8ac984888a">[email&#160;protected]</a></p>
</div>
</div>
</td>
<td>
...
<p class="text-xs text-secondary mb-0"><a href="<?php echo $_CONFIG['url']; ?>/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="9ef3f7fdf6fffbf2defdecfbffeaf7e8fbb3eaf7f3b0fdf1f3">[email&#160;protected]</a></p>
</div>
</div>
</td>
<td>
...
<p class="text-xs text-secondary mb-0"><a href="<?php echo $_CONFIG['url']; ?>/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="60120903080112042003120501140916054d14090d4e030f0d">[email&#160;protected]</a></p>
</div>
</div>
</td>
<td>
