                  ...
                  <div class="row align-items-center h-100">
                    <div class="col-10 mr-auto ml-lg-0 col-lg-5">
                      <div class="main_carousel__content ad-900ms fadeIn text-light px-8 px-md-6 mx-lg-4 mx-xl-0">
                        <h2 class="carousel__heading text-light fadeInDown ad-500ms">God's eye</h2>
                        ...
                        <a class="disabled btn btn-lg bg-dark_A-50 o-1 text-light br-round-0tr br-round-0br parallelogram un_text mb-0"><span class="d-block text-success"><span class="carousel__discount td-lt text-light">349$</span> 299$</span></a>
                        <a href="store-product.php" class="btn btn-lg btn-light parallelogram br-round-0tl br-round-0bl un_text mb-0"><span class="d-block">Buy</span></a>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="d-flex align-items-center h-100">
                <div class="container">
                  <div class="row align-items-center h-100">
                    <div class="col-10 mr-auto ml-lg-0 col-lg-5">
                      <div class="main_carousel__content ad-900ms fadeIn text-light px-8 px-md-6 mx-lg-4 mx-xl-0">
                        <h2 class="carousel__heading text-light fadeInDown ad-500ms">Cybercity 2056</h2>
                        ...
                        <div class="d-flex fadeInLeft ad-900ms">
                        <a class="disabled btn btn-lg bg-dark_A-50 o-1 text-light br-round-0tr br-round-0br parallelogram un_text mb-0"><span class="d-block text-success"><span class="carousel__discount td-lt text-light">220$</span> 199$</span></a>
                        <a href="store-product.php" class="btn btn-lg btn-light parallelogram br-round-0tl br-round-0bl un_text mb-0"><span class="d-block">Buy</span></a>
                        </div>
                      </div>
                    </div>
              ...
              <div class="d-flex align-items-center h-100">
                <div class="container">
                  <div class="row align-items-center h-100">
                    <div class="col-10 mr-auto ml-lg-0 col-lg-5">
                      <div class="main_carousel__content ad-900ms fadeIn text-light px-8 px-md-6 mx-lg-4 mx-xl-0">
                        <h3 class="carousel__heading text-light fadeInDown ad-500ms">The darkness within me</h3>
                        <p class="carousel__text lead-1 mb-6 fadeInDown ad-600ms">Class aptent taciti sociosqu ad litora torquent per conubia, per inceptos himenaeos. Quisque gravida eu lacus et consequat. Interdum et malesuada fames ac ante ipsum primis in faucibus.</p>
                        <div class="d-flex fadeInLeft ad-900ms">
                        <a class="disabled btn btn-lg bg-dark_A-50 o-1 text-light br-round-0tr br-round-0br parallelogram un_text mb-0"><span class="d-block text-success"><span class="carousel__discount td-lt text-light">250$</span> 229$</span></a>
                        <a href="store-product.php" class="btn btn-lg btn-light parallelogram br-round-0tl br-round-0bl un_text mb-0"><span class="d-block">Buy</span></a>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="item-cont">
                      <figure class="owl_item_review">
                        <div>
                          ...
                          <div>
                            <h5 class="owl_item_title text-lt"><a href="store-product.php">Creature 2020</a></h5>
                            <div class="relative small-1">
                              <span class="owl_item_price">€24.99</span>
                    ...
                    <div class="item-cont">
                      <figure class="owl_item_review">
                        <div>
                          ...
                          <div>
                            <h5 class="owl_item_title text-lt"><a href="store-product.php">Shadow Leap</a></h5>
                            <div class="relative small-1">
                              <span class="owl_item_price">€22.99</span>
                              <span class="owl_item_genre">
                                Action, Adventure
                              </span>
                            </div>
                    ...
                    <div class="item-cont">
                      <figure class="owl_item_review">
                        <div>
                          ...
                          <div>
                            <h5 class="owl_item_title text-lt"><a href="store-product.php">MechaOne: New Gen.</a></h5>
                            <div class="relative small-1">
                    ...
                    <div class="item-cont">
                      <figure class="owl_item_review">
                        <div>
                          ...
                          <div>
                            <h5 class="owl_item_title text-lt"><a href="store-product.php">Death Stranding: Golden Mask</a></h5>
                            <div class="relative small-1">
                              <span class="owl_item_price">€44.99</span>
                              <span class="owl_item_genre">
                                Action, Adventure
                    ...
                    <div class="item-cont">
                      <figure class="owl_item_review">
                        <div>
                          ...
                          <div>
                            <h5 class="owl_item_title text-lt"><a href="store-product.php">ONI Deluxe Edition</a></h5>
                            <div class="relative small-1">
                              <span class="owl_item_price">€41.99</span>
                              <span class="owl_item_genre">
                                Action, Adventure
                              </span>
                            </div>
                  ...
                  <div class="item">
                    <div class="item-cont">
                      <figure class="owl_item_review">
                        <div>
                          <div class="position-relative overflow-hidden">
                            <img class="m-0-auto" src="assets/img/content/cont/cg_06.jpg" alt="Games Store">
                            <div class="review_h text-light">
                              <a href="store-product.php">
                                <i class="item_icon_cart fas fa-shopping-cart"></i>
                                <span class="item_atc_text">Add to cart</span>
                          ...
                          <div>
                            <h5 class="owl_item_title text-lt"><a href="store-product.php">Engineer</a></h5>
                            <div class="relative small-1">
                              <span class="owl_item_price">€41.99</span>
                              <span class="owl_item_genre">
                                Action, Adventure
          ...
          <div class="col-xl-6 col-12 py-8 px-4 px-sm-8 py-md-9 px-md-9 br-n bs-c effect-wrapper effect-grayscale position-relative hover" style="background-image: url('assets/img/content/cont/cg-fl_01.jpg');">
            ...
            <div class="row h-100 align-items-center content">
              <div class="col-12 col-md-8 ml-auto text-secondary text-md-right">
                ...
                <a href="store-product.php" class="btn btn-lg btn-outline-secondary btn-round">Explore</a>
              </div>
            </div>
          ...
          <div class="col-xl-6 col-12 py-8 px-4 px-sm-8 py-md-9 px-md-9 br-n bs-c" style="background-image: url('assets/img/content/cont/cg-fl_03.jpg');" data-overlay="7">
            <div class="row align-items-center h-100">
              ...
              <div class="col-md-8 text-light">
                <h2 class="text-light mb-4">Informant</h2>
                ...
                <a href="store-product.php" class="btn btn-lg btn-danger btn-round"><i class="fa fa-shopping-cart mr-5" aria-hidden="true"></i>Buy</a>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="col-xl-6 py-8 px-4 px-sm-8 py-md-9 px-md-9 bs-c" style="background-image: url('assets/img/content/cont/cg-fl_04.jpg');" data-overlay="7">
            <div class="row align-items-center h-100">
              ...
              <div class="col-md-8 order-md-1 text-light text-md-right">
                <h2 class="mb-4">Haku Recalibration</h2>
                <p class="mb-7">Mauris euismod aliquam erat, a vestibulum tortor bibendum sit amet. Duis vitae augue non dolor fermentum faucibus non quis justo. Sed consequat accumsan turpis et semper. Nulla blandit blandit est, nec tincidunt neque sollicitudin vitae.</p>
                <a href="store-product.php" class="btn btn-lg btn-danger btn-round"><i class="fa fa-shopping-cart mr-5" aria-hidden="true"></i>Buy</a>
              </div>
            </div>
          ...
          <div class="col-xl-6 col-sm-12 py-8 px-4 px-sm-8 py-md-9 px-md-9 bs-c effect-wrapper effect-grayscale position-relative hover" style="background-image: url('assets/img/content/cont/cg-fl_02.jpg');">
            ...
            <div class="row h-100 align-items-center content">
              <div class="col-12 col-md-6 mr-auto text-secondary text-left">
                ...
                <h2 class="mb-4">Shark Project</h2>
                <span class="d-block lead-1 text-uppercase ls-3 mb-7">An amazing experience from beginning to end.</span>
                <a href="store-product.php" class="btn btn-lg btn-outline-secondary btn-round">Explore the Sky</a>
              </div>
            </div>
            <figure class="d-none d-md-block effect-layla effect-layla-dark"></figure>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-12 mb-8">
              <div class="row">
                ...
                <div class="col-lg-8">
                  <h4 class="text-uppercase mb-3"><a href="#">Magnis developers speak out on 'death march'</a></h4>
                  <div class="mb-3 small text-info">
                    <span><i class="fas fa-tags"></i> Cras quis lacus dolor, Quisque dictum sollicitudin</span> <span class="mx-1">-</span> <span>4th October 2021</span>
                  </div>
                  ...
                  <a href="news.php" class="btn btn-outline-light">Read More</a>
                </div>
              </div>
            </div>
                ...
                <div class="col-lg-4 mb-6 mb-lg-0">
                  <div class="card">
                    ...
                    <div class="badges badges-left badges-bottom text-white">
                      <div class="rating_circle-wrapper">
                        <span class="rating_circle-foreground">
                            <span class="rating_circle-number">7.4</span>
                        </span>
                        <span class="rating_circle" data-rating-total="7"></span>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="col-lg-8">
                  <h4 class="text-uppercase mb-3">Get Consectetur in the new Humble Bundle</h4>
                  <div class="mb-3 small text-info">
                    <span><i class="fas fa-tags"></i> Cras quis lacus dolor, Quisque dictum sollicitudin</span> <span class="mx-1">-</span> <span>4th October 2021</span>
                  </div>
                  <p>Donec vestibulum, odio a sagittis vestibulum, eros nunc consectetur ex, eu tincidunt neque lacus ac lorem. Mauris interdum urna id eros dignissim convallis. Aliquam convallis, nisi in facilisis tincidunt, augue nunc efficitur lectus, ut auctor orci purus sed neque. Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.</p>
                ...
                <div class="col-lg-4 mb-6 mb-lg-0">
                  <div class="card">
                    ...
                    <div class="badges badges-left badges-bottom text-white">
                      <div class="rating_circle-wrapper">
                        <span class="rating_circle-foreground">
                            <span class="rating_circle-number">8.2</span>
                        </span>
                        <span class="rating_circle" data-rating-total="8"></span>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="col-lg-8">
                  <h4 class="text-uppercase mb-3">Parturient 2 comes with Dante's coat</h4>
                  <div class="mb-3 small text-info">
                    <span><i class="fas fa-tags"></i> Cras quis lacus dolor, Quisque dictum sollicitudin</span> <span class="mx-1">-</span> <span>4th October 2021</span>
                  </div>
                  <p>Donec vestibulum, odio a sagittis vestibulum, eros nunc consectetur ex, eu tincidunt neque lacus ac lorem. Mauris interdum urna id eros dignissim convallis. Aliquam convallis, nisi in facilisis tincidunt, augue nunc efficitur lectus, ut auctor orci purus sed neque. Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.</p>
