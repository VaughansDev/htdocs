...
?>
    ...
    <header class="header">
      ...
      <!-- Start Content Area -->
      <section class="content-section text-light br-n bs-c bp-c pb-8" style="background-image: url(assets/img/bg/bg-5.jpg);">
        <div class="container">
            ...
            <div class="carousel-inner">
                  ...
                  <div class="col-12">
                    <div class="bg-dark d-flex p-4">
                      <div class="flex-1 d-flex align-items-center">
                        <h5 class="mb-0"><a href="store-product.php">Exploration Memories</a></h5>
                      </div>
                      <div class="price d-none d-md-flex flex-wrap align-items-center">
                        <div class="px-3 py-1 my-md-3 my-lg-0 bg-success text-secondary rounded"><span class="fw-600">-15%</span></div>
              ...
              <div class="carousel-item">
                <div class="row">
                  <div class="col-lg-8 pr-lg-1">
                    <a href="#">
                      <div class="d-flex h-100 bs-c br-n bp-c ar-8_5 position-relative" style="background-image: url(assets/img/content/store/02.jpg);">
                      </div>
                    </a>
                  </div>
                  <div class="col-lg-4 d-none d-lg-block pl-lg-1">
                    <div class="row no-gutters h-100">
                      <div class="col-12 pb-1">
                        <a href="#">
                          <div class="d-flex h-100 bs-c br-n bp-c position-relative" style="background-image: url(assets/img/content/store/02-1.jpg);"></div>
                        </a>
                      </div>
                      <div class="col-12 pt-1">
                        <a href="#">
                          <div class="d-flex h-100 bs-c br-n bp-c position-relative" style="background-image: url(assets/img/content/store/02-2.jpg);"></div>
                        </a>
                      </div>
                    </div>
                  </div>
                  <div class="col-12">
                    <div class="bg-dark d-flex p-4">
                      <div class="flex-1 d-flex align-items-center">
                        <h5 class="mb-0"><a href="store-product.php">Journey of the Solarcity</a></h5>
                      </div>
                      <div class="price d-none d-md-flex flex-wrap align-items-center">
                        <div class="px-3 py-1 my-md-3 my-lg-0 bg-success text-secondary rounded"><span class="fw-600">-10%</span></div>
                        <div class="pl-3 d-flex flex-column my-md-3 my-lg-0 lh-1">
              ...
              <div class="carousel-item">
                <div class="row">
                  <div class="col-lg-8 pr-lg-1">
                    <a href="#">
                      <div class="d-flex h-100 bs-c br-n bp-c ar-8_5 position-relative" style="background-image: url(assets/img/content/store/03.jpg);">
                      </div>
                    </a>
                  </div>
                  <div class="col-lg-4 d-none d-lg-block pl-lg-1">
                    <div class="row no-gutters h-100">
                      <div class="col-12 pb-1">
                        <a href="#">
                          <div class="d-flex h-100 bs-c br-n bp-c position-relative" style="background-image: url(assets/img/content/store/03-1.jpg);"></div>
                        </a>
                      </div>
                      <div class="col-12 pt-1">
                        <a href="#">
                          <div class="d-flex h-100 bs-c br-n bp-c position-relative" style="background-image: url(assets/img/content/store/03-2.jpg);"></div>
                        </a>
                      </div>
                    </div>
                  </div>
                  <div class="col-12">
                    <div class="bg-dark d-flex p-4">
                      <div class="flex-1 d-flex align-items-center">
                        <h5 class="mb-0"><a href="store-product.php">Explosive: Blast</a></h5>
                      </div>
                      <div class="price d-none d-md-flex flex-wrap align-items-center">
                        <div class="px-3 py-1 my-md-3 my-lg-0 bg-success text-secondary rounded"><span class="fw-600">-13%</span></div>
                        <div class="pl-3 d-flex flex-column my-md-3 my-lg-0 lh-1">
                    ...
                    <div class="row">
                        ...
                        <a href="store-product.php" class="product-item">
                          <div class="row align-items-center no-gutters">
                            <div class="item_img d-none d-sm-block">
                              <img class="img bl-3 text-primary" src="assets/img/content/store/h-08.jpg" alt="Games Store">
                            </div>
                            ...
                            <div class="item_discount d-none d-sm-block">
                              <div class="row align-items-center h-100 no-gutters">
                                <div class="text-right text-secondary px-6">
                                  <span class="fw-600 btn bg-success">-10%</span>
                                </div>
                              </div>
                            </div>
                      ...
                      <div class="col-md-12 mb-4">
                        <a href="store-product.php" class="product-item">
                          <div class="row align-items-center no-gutters">
                            <div class="item_img d-none d-sm-block">
                              <img class="img bl-3 text-primary" src="assets/img/content/store/h-09.jpg" alt="Games Store">
                            </div>
                            <div class="item_content flex-1 flex-grow pl-0 pl-sm-6 pr-6">
                            ...
                            <div class="item_discount d-none d-sm-block">
                              <div class="row align-items-center h-100 no-gutters">
                                <div class="text-right text-secondary px-6">
                                  <span class="fw-600 btn bg-success">-13%</span>
                                </div>
                              </div>
                            </div>
                            <div class="item_price">
                      ...
                      <div class="col-md-12 mb-4">
                        <a href="store-product.php" class="product-item">
                          <div class="row align-items-center no-gutters">
                            <div class="item_img d-none d-sm-block">
                              <img class="img bl-3 text-primary" src="assets/img/content/store/h-10.jpg" alt="Games Store">
                            </div>
                            <div class="item_content flex-1 flex-grow pl-0 pl-sm-6 pr-6">
                            ...
                            <div class="item_discount d-none d-sm-block">
                              <div class="row align-items-center h-100 no-gutters">
                                <div class="text-right text-secondary px-6">
                                  <span class="fw-600 btn bg-success">-18%</span>
                                </div>
                              </div>
                            </div>
                            <div class="item_price">
                      ...
                      <div class="col-md-12 mb-4">
                        <a href="store-product.php" class="product-item">
                          <div class="row align-items-center no-gutters">
                            <div class="item_img d-none d-sm-block">
                              <img class="img bl-3 text-primary" src="assets/img/content/store/h-01.jpg" alt="Games Store">
                            </div>
                            <div class="item_content flex-1 flex-grow pl-0 pl-sm-6 pr-6">
                            ...
                            <div class="item_discount d-none d-sm-block">
                              <div class="row align-items-center h-100 no-gutters">
                                <div class="text-right text-secondary px-6">
                                  <span class="fw-600 btn bg-success">-22%</span>
                                </div>
                              </div>
                            </div>
                            <div class="item_price">
                      ...
                      <div class="col-md-12 mb-4">
                        <a href="store-product.php" class="product-item">
                          <div class="row align-items-center no-gutters">
                            <div class="item_img d-none d-sm-block">
                              <img class="img bl-3 text-primary" src="assets/img/content/store/h-02.jpg" alt="Games Store">
                            </div>
                            <div class="item_content flex-1 flex-grow pl-0 pl-sm-6 pr-6">
                            ...
                            <div class="item_discount d-none d-sm-block">
                              <div class="row align-items-center h-100 no-gutters">
                                <div class="text-right text-secondary px-6">
                                  <span class="fw-600 btn bg-success">-43%</span>
                                </div>
                              </div>
                            </div>
                            <div class="item_price">
                      ...
                      <div class="col-md-12 mb-4">
                        <a href="store-product.php" class="product-item">
                          <div class="row align-items-center no-gutters">
                            <div class="item_img d-none d-sm-block">
                              <img class="img bl-3 text-primary" src="assets/img/content/store/h-07.jpg" alt="Games Store">
                            </div>
                            <div class="item_content flex-1 flex-grow pl-0 pl-sm-6 pr-6">
          ...
          <div class="row gutters-y">
              ...
              <div class="col-6 col-lg-2">
                ...
                <div class="nav flex-column">
                  ...
                  <a class="nav-link" href="about.php">Careers</a>
                  <a class="nav-link" href="about.php">Cookie Policy</a>
                  <a class="nav-link" href="about.php">Privacy Policy</a>
              ...
              <div class="col-6 col-lg-2">
                ...
                <div class="nav flex-column">
                  <a class="nav-link" href="news.php">Forum</a>
                  <a class="nav-link" href="news.php">Blog</a>
                  <a class="nav-link" href="news.php">News</a>
                  <a class="nav-link" href="news.php">Team</a>
                </div>
              </div>
              ...
              <div class="col-6 col-lg-2">
                ...
                <div class="nav flex-column">
                  ...
                  <a class="nav-link" href="contact.php">Terms & conditions</a>
                  <a class="nav-link" href="contact.php">Refund policy</a>
                </div>
              </div>
              ...
              <div class="col col-lg-3 order-lg-last">
                <div class="mb-2">
                  ...
                  <div class="text-light lead-5">
                    <a href="store.php" class="mr-2"><i class="fab fa-cc-paypal"></i></a>
                    <a href="store.php" class="mr-2"><i class="fab fa-cc-visa"></i></a>
                    <a href="store.php" class="mr-2"><i class="fab fa-cc-amazon-pay"></i></a>
                    <a href="store.php" class="mr-2"><i class="fab fa-cc-stripe"></i></a>
                    <a href="store.php" class="mr-2"><i class="fab fa-cc-jcb"></i></a>
                  </div>
                </div>
                <div>
                  <h6 class="mb-2">Reviews</h6>
                  <div class="text-success lead-1">
    ...
    <div id="offcanvas-cart" class="offcanvas-cart offcanvas text-light h-100 r-0 l-auto d-flex flex-column" data-animation="slideRight">
      ...
      <div class="offcanvas-cart-body flex-1">
        <div class="offcanvas-cart-list row align-items-center no-gutters">
          <div class="ocs-cart-item col-12">
            <div class="row align-items-center no-gutters">
              <div class="col-3 item_img d-none d-sm-block">
                <a href="store-product.php"><img class="img bl-3 text-primary" src="assets/img/content/store/h-08.jpg" alt="Product"></a>
              </div>
              <div class="col-7 flex-1 flex-grow pl-0 pl-sm-4 pr-4">
                <a href="store-product.php"><span class="d-block item_title text-lt ls-1 lh-1 small-1 fw-600 text-uppercase mb-2">Journey of the Solarcity</span></a>
              ...
              <div class="col-2">
                <div class="row align-items-center h-100 no-gutters">
                  <div class="ml-auto text-center">
                    ...
                    <span class="fw-500 text-success">€44.99</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="ocs-cart-item col-12">
            <div class="row align-items-center no-gutters">
              <div class="col-3 item_img d-none d-sm-block">
                <a href="store-product.php"><img class="img bl-3 text-primary" src="assets/img/content/store/h-09.jpg" alt="Product"></a>
              </div>
              <div class="col-7 flex-1 flex-grow pl-0 pl-sm-4 pr-4">
                <a href="store-product.php"><span class="d-block item_title text-lt ls-1 lh-1 small-1 fw-600 text-uppercase mb-2">Exploration Memories</span></a>
                <div class="position-relative lh-1">
                  <div class="number-input">
                    <button onclick="this.parentNode.querySelector('input[type=number]').stepDown()" ><i class="ti-minus"></i></button>
                    <input class="quantity" min="0" name="quantity" value="1" type="number">
              ...
              <div class="col-2">
                <div class="row align-items-center h-100 no-gutters">
                  <div class="ml-auto text-center">
                    <a href="#"><i class="far fa-trash-alt"></i></a><br>
                    <span class="fw-500 text-success">€27.59</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div>
        <a href="checkout-order.php" class="btn btn-lg btn-block btn-outline-light">View cart</a>
      </div>
    </div>
    <!-- /.offcanvas-cart -->
